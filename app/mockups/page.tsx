...
export default function Home() {
  ...
  return <main className="management-page mockupFactory managementOnly">
    <nav className="management-nav" aria-label="Goldie tools"><GoldieWordmark/><a href="/listing-factory">Listing Factory</a><a href="/batches">Batch History</a><a href="/keywords">Keyword Banks</a><a className="active" href="/mockups">Mockup Library</a><a href="/usage">Usage + Plan</a></nav>
    <header className="mockupHero"><p className="mockupEyebrow">YOUR SAVED MOCKUP LIBRARY</p><h1>Your mockup library</h1><p className="lede">Add and organize blank mockups here. You can choose from these sets when you create listing images in the Listing Factory.</p></header>
    <section className="mockupWorkspace"><div className="mockupStep managementLibrary"><div className="managementLibraryHead"><div><p className="mockupEyebrow">SAVED SETS</p><h2>{library.length?"Saved mockups":"Create your first mockup set"}</h2><p>Each set can hold up to 50 blank mockups.</p></div><button className="newSetButton" onClick={()=>setShowAddSet(true)}>＋ Add mockup set</button></div>
