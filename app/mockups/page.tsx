...
export default function Home() {
  ...
  return <main className="management-page mockupFactory managementOnly">
    <nav className="management-nav" aria-label="Goldie tools"><a href="/">Listing Factory</a><a href="/batches">Batch History</a><a href="/keywords">Keyword Banks</a><a className="active" href="/mockups">Mockup Sets</a><a href="/usage">Usage + Plan</a></nav>
  ...
  return <main className="mockupFactory">
    <header className="mockupTopbar"><div className="brand"><span className="brandGold">Goldie</span><span>LISTING FACTORY</span></div><nav className="factoryNav" aria-label="Goldie tools"><a href="/">Listing Factory</a><a href="/batches">Batch History</a><a href="/keywords">Keyword Banks</a><a className="active" href="/mockups">Mockup Sets</a><a href="/usage">Usage + Plan</a></nav><span className="privateNote">Saved mockup library</span></header>
