...
function DraftColorSelector({product,drafts,selected,saving,onChange,onArtworkChange}:{product:TemplateDetails;drafts:DraftResult[];selected:number[];saving:boolean;onChange:(ids:number[])=>void;onArtworkChange:(draft:DraftResult,color:ProductColor,list:FileList|null,reset?:boolean)=>void}){
