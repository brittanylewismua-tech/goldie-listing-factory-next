...
export default function ListingFactoryApp() {
  ...
  useEffect(()=>{void checkEtsyConnection();const url=new URL(window.location.href),message=url.searchParams.get("etsy");if(message){if(message!=="connected")setEtsyError(message);url.searchParams.delete("etsy");window.history.replaceState({},"",url)}},[]);
