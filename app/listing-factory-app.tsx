...
const PROGRESS_STEPS = ["Connect Printify","Choose product","Add designs","Review draft plan","Create Printify drafts","Listing details","Etsy listing details","Listing photos","Publish"];
...
const WORKFLOW_HELP = [
  ...
  {title:"Review the draft plan",intro:"Check exactly what Goldie will create before anything is sent to Printify.",sections:[{heading:"Confirm the scope",copy:"Goldie names the saved product, number of designs, and total private drafts in this run. A product bundle names every included product separately."},{heading:"Confirm the artwork",copy:"Review the primary front artwork, any color-specific alternatives, and any back print before continuing."},{heading:"Nothing publishes to Etsy",copy:"This action creates private Printify drafts only. Etsy publishing remains locked behind the final review and a separate confirmation."},{heading:"Prices come after the drafts",copy:"Once Printify applies every print location, Goldie reads the finished production costs so you can approve accurate prices and shipping."}]},
