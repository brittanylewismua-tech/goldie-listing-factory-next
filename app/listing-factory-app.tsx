...
const WORKFLOW_HELP = [
  ...
  {title:"Complete the final review",intro:"This is the last checkpoint before you finish publishing in Printify.",sections:[{heading:"Open every listing summary",copy:"Review the title, tags, description, Etsy details, prices, shipping, and selected images. Use the edit buttons to return to any unfinished section."},{heading:"Finish in Printify",copy:"The final action opens Printify My Products, where you select and publish the finished drafts."},{heading:"No automatic Etsy charge",copy:"Opening Printify does not publish anything or trigger Etsy listing fees."},{heading:"Keep the batch",copy:"Your work remains available in Batch History if you want to return to it before publishing in Printify."}]},
];
