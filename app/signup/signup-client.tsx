...
export default function SignupClient({ signedIn, checkout, returnTo = "/listing-factory", initialOffer }: { signedIn: boolean; checkout?: string; returnTo?: string; initialOffer?: OfferKey }) {
  ...
  return <main className="signup-page">
    ...
    <section className="signup-next"><div><b>1. Choose your offer</b><span>Pick the access level that fits your listing volume.</span></div><div><b>2. Create your account</b><span>Sign in securely after you choose.</span></div><div><b>3. Start listing</b><span>Connect Printify and Etsy inside Goldie.</span></div></section>
