...
export default function SignupClient({ signedIn, signedInEmail, checkout, returnTo = "/listing-factory", initialOffer }: { signedIn: boolean; signedInEmail?: string; checkout?: string; returnTo?: string; initialOffer?: OfferKey }) {
  ...
  return <main className="signup-page">
    ...
    <section className="signup-hero"><span className="signup-eyebrow">THE GOLDIE LISTING FACTORY</span><h1>Automated Etsy listings like you’ve <span>never seen before</span>.</h1><p className="signup-hero-tagline">Let Goldie AI be your ultimate listing automation assistant.</p><div className="signup-proof"><span>Listing creation</span><span>Pricing + Etsy details</span><span>Your own listing photos</span></div></section>
