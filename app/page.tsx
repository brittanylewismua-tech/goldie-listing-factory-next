  ...
  return (
    <section className={"variant-pricing "+(approved?"approved":"")}>
      <div className="variant-pricing-head">
        <div><p className="mini-label">PRICING</p><h3>Review shipping and item prices.</h3><p>Your template’s current prices are shown below.</p></div>
