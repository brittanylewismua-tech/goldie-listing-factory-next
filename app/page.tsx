...
import { GoldieCommandBar, loadCommandCenterData, type CommandCenterData } from "./returning-command-center";
...
export default function Home() {
  ...
  useEffect(()=>{void loadCommandCenterData().then(setCommandCenterData).catch(()=>setCommandCenterData(null))},[]);
