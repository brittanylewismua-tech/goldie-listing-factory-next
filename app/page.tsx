...
export default function Home() {
  ...
  async function preparedUpload(design: DesignFile) {
    ...
    const rigidPaperProduct=/poster|print|canvas|paper/i.test(`${templateDetails?.blueprintTitle||""} ${templateDetails?.brand||""} ${templateDetails?.model||""}`);
