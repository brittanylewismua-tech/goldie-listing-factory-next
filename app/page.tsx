...
const WORKFLOW_HELP = [
  ...
  {title:"Choose or create a saved product",intro:"A saved product tells Goldie exactly which Printify setup to copy for every design in this batch.",sections:[{heading:"What the template controls",copy:"The template supplies the product, print provider, artwork placement, enabled variants, Printify mockups, description, connected Etsy shop, and shipping profile."},{heading:"Prepare it in Printify first",copy:"Open the product editor, add temporary artwork, set the placement, enable the sizes and colors you want, choose mockups, set shipping, and publish it to Etsy once. You may deactivate that Etsy listing afterward."},{heading:"Paste the correct link",copy:"Copy the full URL from the browser address bar while the Printify product editor is open. Do not paste an Etsy URL or a product ID by itself."},{heading:"Product bundles",copy:"Choose a bundle only when the same artwork should be created on two to four different saved products. You upload each design once, then complete pricing and listing details for one product at a time."}]},
