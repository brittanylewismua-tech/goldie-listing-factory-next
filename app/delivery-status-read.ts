...
export async function readDeliveryStatus<T>(response:Response):Promise<T[]>{
 if(response.status===401)throw Error('Sign in to the Listing Factory in another tab, then choose Check saved progress here. Your saved drafts have not been changed.');
