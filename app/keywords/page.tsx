...
export default function KeywordBanks() {
  ...
  return <FactoryShell active="keywords" title="Keyword Banks"><div className="management-page keyword-page interior-page">
    ...
    <header className="keyword-hero"><div><p className="mini-label">KEYWORD BANKS</p><h1>Your keyword banks</h1><p>Save your organized eRank phrases here, then choose the bank you want while building listing titles.</p></div><button type="button" className="primary-action" onClick={()=>{startAnother();setScrollToEditor(true)}}>New keyword bank</button></header>
