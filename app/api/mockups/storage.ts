...
/* The two mockup_render_* tables were created here for the AI mockup
   generator. That feature is gone and nothing reads them; the existing rows
   are left in place rather than dropped, because deleting a seller's history
