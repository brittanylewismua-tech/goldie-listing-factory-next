...
type Props = { drafts:Draft[]; files:Design[]; selections:Record<string,number[]>; defaultIndices:number[]; batchSizeGuide:string; onEdit:(phase:"details"|"mockups")=>void };

export default function FinalListingReview({drafts,files,selections,defaultIndices,batchSizeGuide,onEdit}:Props){
