...
export const planFor = (key?: string | null, owner = false) => owner ? OWNER_TEST_PLAN : key === "trial" ? TRIAL_PLAN : key === "mastermind_beta" ? MASTERMIND_BETA_PLAN : PLANS[(key && key in PLANS ? key : "goldie") as PlanKey];
