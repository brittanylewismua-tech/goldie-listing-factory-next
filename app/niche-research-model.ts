...
const buyerPatterns=[
 {name:'Book clubs',re:/\bbook club\b/i},{name:'Birthday gifts',re:/\bbirthday\b/i},{name:'Gifts for friends',re:/\b(?:friend|bestie|best friend)\b/i},{name:'Gifts for family',re:/\b(?:daughter|sister|mom|mother|wife|husband|son|dad|father)\b/i},{name:'Group purchases',re:/\b(?:matching|our group|everyone in|girls trip|bachelorette)\b/i},{name:'Comfort and softness',re:/\b(?:soft|comfortable|comfy)\b/i},{name:'Fit concerns',re:/\b(?:too small|too big|runs small|runs large|sizing was off|size was wrong)\b/i},{name:'Print concerns',re:/\b(?:faded|peeling|blurry|print.*(?:bad|poor|crooked))\b/i},{name:'Requests for more options',re:/\b(?:wish|would love|please make|more colors|more colours)\b/i},
];
