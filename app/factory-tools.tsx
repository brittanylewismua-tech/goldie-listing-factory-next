...
export function SavedWorkflow(props: WorkflowProps) {
  ...
  return <article className="step-card recipe-card"><div className="step-number" aria-hidden="true"/><div className="step-content"><div className="step-heading"><div><p className="mini-label">YOUR PRODUCT</p><h2>Product</h2></div></div><p className="step-copy">Choose it once. Goldie remembers the product details, pricing, shipping, keywords, and Etsy settings for every future batch.</p>
