...
let previewFace:{left:number;top:number;right:number;bottom:number}|undefined;
 ...
 return <><div className="integrated-mockups"><div className="mockup-limit-note"><b>Lifestyle mockups for this listing</b><span>Goldie processes them in a reliable queue.</span></div>{/* D566 - her words: "it says mockups, and then you pick your mockup set. And
