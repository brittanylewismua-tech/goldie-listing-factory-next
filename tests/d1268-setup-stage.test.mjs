...
test("the first stage names both jobs that actually appear on its page",()=>{
  ...
  assert.match(app,/setup: templateDetails&&productSelected&&!showProductLibrary[\s\S]*title: files\.length\?"Review your product and designs":"Add your designs"[\s\S]*title: "Choose a product or bundle"/);
