...
test("the draft-plan screen names the action that is actually available",()=>{
  assert.match(app,/designs: complete[\s\S]*title: "Review photos and final product choices"[\s\S]*title: "Create Printify drafts", copy: "Review the plan, then create the private drafts\."/);
});
