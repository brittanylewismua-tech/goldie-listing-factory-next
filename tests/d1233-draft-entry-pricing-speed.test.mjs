...
test('D1233: local cache work overlaps provider work and polling checks immediately',()=>{
  ...
  assert.match(app,/Promise\.all\(\[providerCompletion,Promise\.all\(cacheWrites\)\]\)/);
});
