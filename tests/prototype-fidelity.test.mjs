...
const CASES = [
  ...
  { name: "publish box background", chain: [...shell, el("div","factory-review"), el("div","factory-publish-box")], property: "background", expect: /^#080808$/ },
  ...
  { name: "publish box body is light", chain: [...shell, el("div","factory-review"), el("div","factory-publish-box"), el("p")], property: "color", expect: /^rgba\(255,255,255,\.76\)$/ },
