...
const CASES = [
  ...
  { name: "publish box background", chain: [...shell, el("div","factory-review"), el("div","factory-publish-box")], property: "background", expect: /^rgba\(255,244,250,\.84\)$/ },
  ...
  { name: "publish box heading is dark", chain: [...shell, el("div","factory-review"), el("div","factory-publish-box"), el("h3")], property: "color", expect: /^#2d2229$/ },
  { name: "publish box body is dark", chain: [...shell, el("div","factory-review"), el("div","factory-publish-box"), el("p")], property: "color", expect: /^#6d5966$/ },
  ...
  { name: "review row columns", chain: [...shell, el("div","final-listing-grid"), el("article","final-listing-card")], property: "grid-template-columns", expect: /^28px 96px minmax\(0,1fr\)$/ },
  { name: "review thumb size", chain: [...shell, el("div","final-listing-grid"), el("article","final-listing-card"), el("img","final-listing-no-image")], property: "height", expect: /^96px$/ },
