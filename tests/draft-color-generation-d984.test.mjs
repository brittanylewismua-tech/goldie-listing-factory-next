...
import {creationVariantIds,mockupCoverageComplete,restoredVariants} from "../app/draft-preview-variants.ts";
...
test("D984 sends the broad preview set but keeps the seller selection separate",()=>{
  ...
  assert.match(app,/const mockupVariants=variantsFor[\s\S]{0,500}const variants=mockupVariants;[\s\S]{0,900}artworkAssignments=/);
